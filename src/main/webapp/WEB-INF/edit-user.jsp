...
<form name="registration" method="POST" action="${pageContext.request.contextPath}/edit"
...
onsubmit="return formValidation()">
    ...
    <td><input type="password" name="password" placeholder="Password" id="password" minlength="2"
    maxlength="20"></td>
    </tr>
    <tr>
    <td><label for="confirm_password">Confirm password:</label></td>
    <td><input type="password" placeholder="Confirm Password" id="confirm_password" minlength="2"
    maxlength="20"></td>
    </tr>
    <tr>
    ...
    <tr>
    <td colspan="2"><input type="submit" class="submit" onclick="return Validate()" value="Edit"/></td>
    </tr>
    <tr>
